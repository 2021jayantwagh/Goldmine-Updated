...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadUserProfile() async {
    ...
    try {
        ...
        if (adminData == null) {
          ...
          setState(() {
            ...
            _emailController.text =
                adminData['email'] ?? 'sahilbagal877@gmail.com';
            _phoneController.text =
                adminData['phone_number'] ?? '+91 98765 43210';
      ...
      // Regular user handling from here
      if (user == null) {
      ...
      // Check if admin, and if so, provide default data
      final isAdmin = await _authController.verifyAdminStatus();
      if (isAdmin) {
        setState(() {
          _fullNameController.text = 'Admin User';
      ...
      if (user != null) {
        ...
        // No user logged in, navigate to login (only for non-admin)
        Get.offAllNamed('/login');
      }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // Admin badge if email is admin email
              if (_emailController.text == 'sahilbagal877@gmail.com')
                Container(
  ...
  Widget _settingsSection(BuildContext context) {
    // Check if current user is admin by using auth controller
    bool isAdmin = _authController.isAdmin.value;
